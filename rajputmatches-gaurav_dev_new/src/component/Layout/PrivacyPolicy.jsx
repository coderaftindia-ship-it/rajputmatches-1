              ...
              >
                ...
                <section className="mb-5">
                  ...
                  <p className="mb-0" style={{ color: "var(--royal-text)", lineHeight: "1.8" }}>
                    ...
                    that all such disputes and/or differences will be governed by the laws of Canada  and shall be subject to the exclusive 
                    jurisdiction of the Competent Courts in Toronto, Ontario, Canada  only.
                  </p>
                </section>
